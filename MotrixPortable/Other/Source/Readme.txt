...
user in an INI file next to MotrixPortable.exe called MotrixPortable.ini.
...
copy AppNamePortable.ini from this directory to MotrixPortable.ini next to
MotrixPortable.exe. The options in the INI file are as follows:
